...
folder = '/home/srallaba/projects/personality_stuff/voices/cmu_us_LJspeech/wav'
feats = '/home/srallaba/projects/personality_stuff/voices/cmu_us_LJspeech/feats'
...
for file in files:
 ...
 mel_spec = (_linear_to_mel(np.abs(spec)))
