...
class Decoder(nn.Module):
    def __init__(self, in_dim, r):
        ...
        self.in_dim = in_dim
        self.r = r
        print("in dim and r are", in_dim,r)
    ...
    def forward(self, encoder_outputs, inputs=None, memory_lengths=None):
        ...
        while True:
            ...
            # Prenet
#            print("inital input", current_input)
            ...
            if greedy:
                if t > 1 and is_end_of_frames(output):
                    print("breaking becase", is_end_of_frames(output), "out data is", numpy.shape(output.data), output.data)
                    break
